  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (formData.import_past_tasks) {
        const { error: tasksError } = await supabase.rpc("generate_tasks_for_company", {
        ...
        {steps.map((step, index) => (
          <div key={step.id} className="flex items-center flex-1">
            ...
            {index < steps.length - 1 && (
              <div
                className={cn("h-0.5 flex-1 transition-colors", currentStep > step.id ? "bg-primary" : "bg-muted")}
              />
            )}
          </div>
        ))}
          ...
          {currentStep === 2 && (
            <div className="space-y-4">
              ...
              <RadioGroup
                ...
                onValueChange={(value) => updateFormData("organization_type", value)}
              >
                <div className="space-y-3">
                  <div className="flex items-start space-x-3 rounded-lg border p-4 hover:bg-accent cursor-pointer">
                    <RadioGroupItem value="SRL" id="srl" className="mt-1" />
                    <div className="flex-1">
                      <Label htmlFor="srl" className="cursor-pointer font-medium">
                  ...
                  <div className="flex items-start space-x-3 rounded-lg border p-4 hover:bg-accent cursor-pointer">
                    <RadioGroupItem value="ÎI" id="ii" className="mt-1" />
                    <div className="flex-1">
                      <Label htmlFor="ii" className="cursor-pointer font-medium">
                  ...
                  <div className="flex items-start space-x-3 rounded-lg border p-4 hover:bg-accent cursor-pointer">
                    <RadioGroupItem value="ÎP" id="ip" className="mt-1" />
                    <div className="flex-1">
                      <Label htmlFor="ip" className="cursor-pointer font-medium">
                  ...
                  <div className="flex items-start space-x-3 rounded-lg border p-4 hover:bg-accent cursor-pointer">
                    <RadioGroupItem value="ONG" id="ong" className="mt-1" />
                    <div className="flex-1">
                      <Label htmlFor="ong" className="cursor-pointer font-medium">
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => updateFormData("is_tva_payer", checked)}
                  />
                  <Label htmlFor="tva_payer" className="cursor-pointer font-normal">
                    TVA Plătitor
                  </Label>
                </div>
                {formData.is_tva_payer && (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="trimestrial" className="cursor-pointer font-normal">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="has_employees" className="cursor-pointer font-normal">
                    Has Employees
                  </Label>
                </div>
                {formData.has_employees && (
                  <div className="ml-6 space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => updateFormData("employee_count", Number.parseInt(e.target.value) || 0)}
                      className="w-32"
                    />
                  </div>
                )}
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.tax_regime} onValueChange={(value) => updateFormData("tax_regime", value)}>
                  <SelectTrigger id="tax_regime">
                    <SelectValue placeholder="Select tax regime" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="general">General taxation regime</SelectItem>
                    <SelectItem value="simplified">Simplified (Microenterprise 4%)</SelectItem>
                    <SelectItem value="agricultural">Agricultural tax</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateFormData("accounting_start_date", e.target.value)}
                />
              </div>
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateFormData("import_past_tasks", checked)}
                />
                <Label htmlFor="import_past_tasks" className="cursor-pointer font-normal">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <dl className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <dd className="font-medium">{formData.organization_type}</dd>
                  </div>
                </dl>
              </div>
              ...
              <div>
                ...
                <dl className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <dd className="font-medium">{formData.is_tva_payer ? `Yes (${formData.tva_type})` : "No"}</dd>
                  </div>
                  <div className="flex justify-between">
                    <dt className="text-muted-foreground">Employees:</dt>
                    <dd className="font-medium">
                      {formData.has_employees ? `${formData.employee_count} employees` : "No employees"}
                    </dd>
                  </div>
                  <div className="flex justify-between">
                    <dt className="text-muted-foreground">Tax Regime:</dt>
                    <dd className="font-medium capitalize">{formData.tax_regime}</dd>
                  </div>
                  <div className="flex justify-between">
                    <dt className="text-muted-foreground">Start Date:</dt>
                    <dd className="font-medium">{formData.accounting_start_date}</dd>
                  </div>
                </dl>
              </div>
              ...
              <div className="rounded-lg bg-blue-50 p-4 border border-blue-200">
                <p className="text-sm text-blue-900">
                  <strong>Tasks to be created:</strong> Based on your company settings, we will automatically generate
                  the appropriate accounting tasks and deadlines.
                </p>
              </div>
            </div>
          )}
